...
class Embedding(nn.Module):
    def __init__(self, params, path='../../../', flag=False):
        ...
        self.word_embed = nn.Embedding(params.word_vocab_size, params.word_embed_size)
        self.char_embed = nn.Embedding(params.char_vocab_size, params.char_embed_size)
        self.word_embed.weight = Parameter(t.from_numpy(word_embed).float(), requires_grad=False)
        self.char_embed.weight = Parameter(t.Tensor(params.char_vocab_size, params.char_embed_size).uniform_(-1, 1))
